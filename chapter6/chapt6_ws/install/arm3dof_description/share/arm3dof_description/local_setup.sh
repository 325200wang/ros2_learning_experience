...
: ${AMENT_CURRENT_PREFIX:="/media/dubhe/store/learning/ros2_learning_experience/chapter6/chapt6_ws/install/arm3dof_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm3dof_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm3dof_description/environment/path.sh"
